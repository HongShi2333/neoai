...
type ApiInfo struct {
        ...
        RegistrationCode       bool     `json:"registration_code"`
...
func (c *SystemConfig) AsInfo() ApiInfo {
        return ApiInfo{
                ...
                RegistrationCode:    utils.GetBoolWithDefault("system.registration.require_code", false),
                LinuxDoOAuthEnabled: utils.GetStringWithDefault("system.oauth.linuxdo.client_id", "") != "",
                GitHubOAuthEnabled:  utils.GetStringWithDefault("system.oauth.github.client_id", "") != "",
        }
}
